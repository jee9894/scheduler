	...
	<nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-secondary">
		...
		<div class="collapse navbar-collapse col" id="navbarTogglerDemo02">
			<ul class="navbar-nav mr-auto mt-2 mt-lg-0">
				<li class="nav-item text-white col">Title <input class="form-control form-control-sm" type="text" id="title-txt"></li>
				<li class="nav-item text-white col">Color <input class="form-control form-control-sm" type="color" id="color-select" value="#FFFFFF"></li>
				<li class="nav-item text-white col">Image <input class="form-control form-control-sm" type="text" id="image-url"></li>
				<li class="nav-item text-white col">Select Menu
					<select class="form-control form-control-sm" id="select-menu">
